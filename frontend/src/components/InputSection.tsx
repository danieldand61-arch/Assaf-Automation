...
const PLATFORMS = [
  ...
  { id: 'tiktok',          label: 'TikTok',          color: '#010101', icon: 'tk' },
  { id: 'x',               label: 'X (Twitter)',     color: '#1DA1F2', icon: 'x' },
            ...
            {PLATFORMS.map(p => {
              ...
              return (
                ...
                >
                  ...
                  <span className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-bold"
