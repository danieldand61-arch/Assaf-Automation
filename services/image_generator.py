...
PHOTOGRAPHY STYLE:
- Shot in a REAL location, not a studio. Natural imperfections welcome.
- Natural ambient lighting with subtle shadows. NOT perfectly even studio lighting.
- Shallow depth of field with slightly imperfect focus.
- Minor grain, subtle lens flare, or natural bokeh artifacts to feel like a real camera shot.

REALISM RULES (CRITICAL):
- AVOID human faces or close-up portraits. If people are needed, show hands, back angles, silhouettes, or cropped body shots only.
- AVOID the "AI look": no hyper-smooth skin, no plastic textures, no impossible symmetry, no unnaturally vibrant colors.
- Include natural imperfections: slightly wrinkled fabric, condensation on glass, dust particles in light, worn edges on objects, asymmetric arrangements.
- Textures must feel tangible: real wood grain, actual fabric weave, genuine metal scratches, real paper texture.
- The image should look like it was taken by a skilled photographer with a real camera, NOT generated by AI.
- Focus on PRODUCTS, OBJECTS, ENVIRONMENTS, and TEXTURES rather than people.

COMPOSITION:
- One hero subject that represents the scenario from the post
- Environmental storytelling through real-looking props and setting
...
- The image MUST match the post content. Generic imagery is FORBIDDEN."""
